...
module.exports = class SubscriptionsService {
  static async create(data, currentUser) {
    ...
    try {
      await SubscriptionsDBApi.create(data, {
        currentUser,
        transaction,
      });
  ...
  static async update(data, id, currentUser) {
    ...
    try {
      ...
      if (!subscriptions) {
        throw new ValidationError('subscriptionsNotFound');
      }

      await SubscriptionsDBApi.update(id, data, {
        currentUser,
        transaction,
      });
  ...
  static async remove(id, currentUser) {
    ...
    try {
      await SubscriptionsDBApi.remove(id, {
        currentUser,
        transaction,
      });
