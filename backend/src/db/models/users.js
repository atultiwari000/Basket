...
module.exports = function (sequelize, DataTypes) {
  ...
  users.associate = (db) => {
    ...
    db.users.hasMany(db.customer_profiles, {
      as: 'customer_profiles_customer',
      foreignKey: {
        name: 'customerId',
      },
      constraints: false,
    ...
    db.users.hasMany(db.supplier_profiles, {
      as: 'supplier_profiles_supplier',
      foreignKey: {
        name: 'supplierId',
      },
      constraints: false,
