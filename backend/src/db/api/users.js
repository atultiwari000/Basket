...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.customer_profiles_customer =
      await users.getCustomer_profiles_customer({
        transaction,
      });

    output.deliveries_delivery_staff = await users.getDeliveries_delivery_staff(
      {
        transaction,
      },
    );
    ...
    output.supplier_profiles_supplier =
      await users.getSupplier_profiles_supplier({
        transaction,
      });
