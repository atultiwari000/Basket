  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
            ...
            <CardBox hasTable key={item.id} className={'rounded'}>
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>TargetAudience</p>
                    <p className={'line-clamp-2'}>{item.target_audience}</p>
                  </div>
        ...
        {!loading && marketing_campaigns.length === 0 && (
...
export default ListMarketing_campaigns;
