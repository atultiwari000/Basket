  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
              ...
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.preferences}</p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>{item.subscription_status}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
        ...
        {!loading && customer_profiles.length === 0 && (
...
export default ListCustomer_profiles;
