...
import { create } from '../../stores/marketing_campaigns/marketing_campaignsSlice';
...
Marketing_campaignsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_MARKETING_CAMPAIGNS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Marketing_campaignsNew;
