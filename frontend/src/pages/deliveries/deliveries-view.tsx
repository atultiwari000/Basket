    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>DeliveryStaff</p>

            <p>{deliveries?.delivery_staff?.firstName ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>PickupStatus</p>
            <p>{deliveries?.pickup_status ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>DeliveryStatus</p>
            <p>{deliveries?.delivery_status ?? 'No data'}</p>
          </div>
          ...
          <FormField label='Multi Text' hasTextareaHeight>
            <textarea
              className={'w-full'}
              disabled
              value={deliveries?.special_instructions}
            />
          </FormField>
